...
const TrendingPage = () => {
  //sample data
  const trendingGames = [
    { id: 1, title: 'Cyberpunk 2077', image: 'https://via.placeholder.com/150x200/4A90E2/FFFFFF?text=Game+1' },
    { id: 2, title: 'The Witcher 3', image: 'https://via.placeholder.com/150x200/E74C3C/FFFFFF?text=Game+2' },
